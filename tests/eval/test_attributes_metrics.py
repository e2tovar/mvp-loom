...
def test_perfect_match_f1_is_one():
    ...
    pred = [
        {"character_id": "cid_ana", "key": "eye_color", "value_norm": "green",
         "attr_class": "static"},
        {"character_id": "cid_ana", "key": "eye_color", "value_norm": "blue",
         "attr_class": "static"},
    ]
...
def test_stateful_bucket_split():
    ...
    pred = [
        {"character_id": "cid_d", "key": "status", "value_norm": "dead", "attr_class": "stateful"},
    ]
